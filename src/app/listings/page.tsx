import { Button, Card, CardBody, CardFooter, CardHeader, Heading, Text, SimpleGrid, Stack, Divider } from '@chakra-ui/react'
...
async function getData() {
    ...
    //TODO
    const listings: Array<DirectListingV3> = await contract.directListings.getAll();
